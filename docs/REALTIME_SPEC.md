...
const task = await fetch('http://192.168.0.216:3000/api/tasks?status=inbox').then(r => r.json());

// 2. Log triage activity
await fetch(`http://192.168.0.216:3000/api/tasks/${task.id}/activities`, {
  method: 'POST',
  body: JSON.stringify({
...
// 3. Update status
await fetch(`http://192.168.0.216:3000/api/tasks/${task.id}`, {
  method: 'PATCH',
...
await fetch(`http://192.168.0.216:3000/api/tasks/${task.id}/subagent`, {
  method: 'POST',
  body: JSON.stringify({
...
await fetch(`http://192.168.0.216:3000/api/tasks/${task.id}/deliverables`, {
  method: 'POST',
  body: JSON.stringify({
