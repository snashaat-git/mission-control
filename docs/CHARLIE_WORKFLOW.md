...
// Now safe to approve
await fetch('http://192.168.0.216:3000/api/tasks/task-abc123', {
  method: 'PATCH',
...
```typescript
// Register sub-agent
await fetch('http://192.168.0.216:3000/api/tasks/TASK_ID/subagent', {
  method: 'POST',
  headers: { 'Content-Type': 'application/json' },
  body: JSON.stringify({
...
// Log activity
await fetch('http://192.168.0.216:3000/api/tasks/TASK_ID/activities', {
  method: 'POST',
  headers: { 'Content-Type': 'application/json' },
  body: JSON.stringify({
...
// Log deliverable
await fetch('http://192.168.0.216:3000/api/tasks/TASK_ID/deliverables', {
  method: 'POST',
  headers: { 'Content-Type': 'application/json' },
  body: JSON.stringify({
...
// Complete session
await fetch('http://192.168.0.216:3000/api/openclaw/sessions/SESSION_ID', {
  method: 'PATCH',
  headers: { 'Content-Type': 'application/json' },
  body: JSON.stringify({
    status: 'completed',
